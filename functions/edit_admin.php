...
if(isset($_POST['edit'])) {
  if(isset($_GET['id'])) {
    ...
    $admin_edit_query = "UPDATE data_penitipan SET waktu_penerimaan = '$waktu_penerimaan', waktu_pengembalian = '$waktu_pengembalian', biaya_penitipan = '$biaya_penitipan', id_petugas='$id_petugas' WHERE nik_pemilik = '$id'";
