      ...
      <form action="../functions/edit_hewan.php?id=<?=$data_hewan['id_hewan']?>" method="POST">
        <fieldset> 
          <div class="mb-3">
            ...
            <input type="text" class="form-control" placeholder="Masukkan Jenis Hewan Anda" name="jenis_hewan" value="<?= $data_hewan['jenis_hewan']?>">
          </div>
          <div class="mb-3">
            <label> Umur Hewan </label>
            <input type="text" class="form-control" placeholder="Masukkan Umur Hewan Anda" name="umur" value="<?= $data_hewan['umur']?>">
          </div>
          <div class="mb-3">
            <label> Riwayat Penyakit </label>
            <input type="text" class="form-control" placeholder="Masukkan Riwayat Penyakit Hewan Anda (Jika Ada)" name="penyakit" value="<?= $data_hewan['penyakit']?>">
          </div>
